...
try {
  // Read the JSON file
  const jsonData = JSON.parse(fs.readFileSync('./frankfamily/frankfamily.json', 'utf8'));
    ...
    const data = jsonArray
      ...
      .map(product => {
        ...
        const mappedProduct = {
          ...
          distributor_name: product?.distributor || "Frank Family Vineyards",
  ...
  saveCSV(csvString, 'frankfamily.csv');
