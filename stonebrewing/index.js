...
try {
  // Read the JSON file
  const jsonData = JSON.parse(fs.readFileSync('./beerstonebrewing.json', 'utf8'));
      ...
      .map(product => {
        ...
        return {
         ...
         retail_price: product?.price || "",
          ...
          distributor_name: product?.distrubutor || "Stone Brewing",
  ...
  saveCSV(csvString, 'beerstonebrewing.csv');
