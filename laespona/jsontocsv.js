...
try {
  // Read the JSON file
  const jsonData = JSON.parse(fs.readFileSync('./SWEETS/Quince.json', 'utf8'));
    ...
    const data = jsonArray
      ...
      .map(product => {
        ...
        const mappedProduct = {
          ...
          distributor_name: product?.distributor || "LA ESPAÑOLA MEATS, INC.",
