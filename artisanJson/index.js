...
try {
  // Read the JSON file
  const jsonData = JSON.parse(fs.readFileSync('./proteins.json', 'utf8'));
    ...
    const data = jsonArray
      ...
      .map(product => {
        ...
        const mappedProduct = {
          ...
          distributor_name: product?.distributor || " Artisan Specialty Foods",
  ...
  saveCSV(csvString, 'proteins.csv');
