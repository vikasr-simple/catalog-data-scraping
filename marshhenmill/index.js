...
try {
  // Read the JSON file
  const jsonData = JSON.parse(fs.readFileSync('./lesluneswine/leslunwine.json', 'utf8'));
    ...
    const data = jsonArray
      ...
      .map(product => {
        ...
        const mappedProduct = {
          ...
          distributor_name: product?.distributor || "Les Lunes Wine",
  ...
  saveCSV(csvString, 'leslunwine.csv');
